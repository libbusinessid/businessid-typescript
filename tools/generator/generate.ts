 ...
 * The generator.
 *
 * It reads a rule bundle, applies the twenty four load time checks of `ir.md`
 ...
 * it calls.
 */
import { checkExpansion } from "./emit/expansion.js";
 ...
 *
 * @throws BundleError when any of the twenty four checks refuses the bundle.
 */
